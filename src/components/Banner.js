          ...
          <Col xs={12} md={6} xl={7}>
            <TrackVisibility>
              ...
              <div className={isVisible ? "animate__animated animate__fadeIn" : ""}>
                <span className="tagline">Миний портфолио :))</span>
                <h1>{`Henlou,I'm Baljkaa!`} <span className="txt-rotate" dataPeriod="1000" data-rotate='[ "Software Engineerr", "Physicist", "Med student" ]'><span className="wrap">{text}</span></span></h1>
                  <p>"Be not afraid of greatness. Some are born great, some achieve greatness, and others have greatness thrust upon them.”
                  <br></br><br></br>William Shakespeare (1564–1616)</p>
                  <button onClick={() => console.log('connect')}>Надтай холбогдох<ArrowRightCircle size={25} /></button>
              </div>}
            </TrackVisibility>
          </Col>
          <Col xs={12} md={6} xl={5}>
